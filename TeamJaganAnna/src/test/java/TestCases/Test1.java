...
public class Test1 extends DriverUtility {
...
*/
	...
	public void LoginPage() throws Exception {
		...
		/*
		  ...
		  getmobileDriver().findElement(By.xpath(NONE)).click(); Thread.sleep(3000);
		...
		*/ 
		...
		WebElement ALLOW1 = getmobileDriver().findElement(By.xpath(
	...
	@Test(priority = 2) 
		public void scrollByID(String className, int index) throws InterruptedException {

	        try {

	             mobileDriver.findElement(MobileBy.AndroidUIAutomator("new UiScrollable(new UiSelector().scrollable(true).instance(0)).scrollIntoView(new UiSelector().className(\""+className+"\").instance("+index+"));")); 
...
////////////////////////////////////
			WebElement LeftIcon = getmobileDriver()
	 ...
	 public void ProfilePage() throws Exception {
	  ...
	  WebElement Profile = getmobileDriver() .findElement(By.
	  ...
	  WebElement ProfileName1 = getmobileDriver().findElement(By.xpath("//android.widget.TextView[@resource-id=\"com.tja:id/tv_toolbar_title\"]"));
	 ...
	 // Assuming you have already located the username WebElement WebElement
	  WebElement ProfileName = getmobileDriver().findElement(By.xpath( "//android.widget.TextView[@resource-id=\"com.tja:id/tv_profile_name\"]"));
	  ...
	  WebElement userContactElement = getmobileDriver().findElement(By.xpath("//android.widget.TextView[@resource-id=\"com.tja:id/tv_user_contact\"]"));
	  ...
	  WebElement userLevelElement = getmobileDriver().findElement(By.xpath("//android.widget.TextView[@resource-id=\"com.tja:id/level_tv\"]"));
	  ...
	  WebElement getVerifiedElement = getmobileDriver().findElement(By.xpath("//android.widget.TextView[@resource-id=\"com.tja:id/tvBtnVerifyProfile\"]"));
	  ...
	  WebElement BasicDetailsElement = getmobileDriver().findElement(By.xpath("//android.widget.TextView[@resource-id=\"com.tja:id/tv_basic_detail\"]"));
	  ...
	  WebElement FBTitle = getmobileDriver().findElement(By.xpath("//android.widget.TextView[@resource-id=\"com.tja:id/tvFb\"]"));
     ...
     WebElement Notification = getmobileDriver() .findElement(By.xpath("//android.widget.ImageView[@resource-id=\"com.tja:id/iv_right_icon\"]"));
	 Notification.click(); 
	 Thread.sleep(2000); 
	 getExtentTest().log(LogStatus.PASS,"Successfully Cliked on Notification");
	  
	
	  WebElement NtfnLeftIcon = getmobileDriver() .findElement(By.xpath("//android.widget.ImageView[@resource-id=\"com.tja:id/iv_left_icon\"]"));
	  NtfnLeftIcon.click(); 
	  Thread.sleep(2000);
	 ...
	 public void GetVerifiedPage() throws Exception {
	  ...
	  WebElement GetVerified1 = getmobileDriver() .findElement(By.xpath(
	  ...
	  WebElement ChooseyourCategory = getmobileDriver().findElement(By.xpath("//android.widget.TextView[@text=\"Choose your Category\"]"));
	 ...
	 } else
	 {
	  ...
	  WebElement SMediaWarrior = getmobileDriver().findElement(By.xpath("//android.widget.TextView[@resource-id=\"com.tja:id/tvIpacVolunter\"]"));
	  ...
	  WebElement PartyMember = getmobileDriver().findElement(By.xpath("//android.widget.TextView[@resource-id=\"com.tja:id/tvIpacWorker\"]"));
	  ...
	  WebElement SMWarrior = getmobileDriver() .findElement(By.xpath("//android.widget.TextView[@resource-id=\"com.tja:id/tvIpacVolunter\"]"));
	  SMWarrior.click(); 
	  Thread.sleep(2000); 
	  getExtentTest().log(LogStatus.PASS,"Successfully Cliked on SMWarrior");
	
	  
	  WebElement LeftIcon = getmobileDriver() .findElement(By.xpath("//android.widget.ImageView[@resource-id=\"com.tja:id/iv_left_icon\"]"));
	  LeftIcon.click(); 
	  Thread.sleep(2000); 
	 ...
	 WebElement PartyMember1 = getmobileDriver() .findElement(By.xpath("//android.widget.TextView[@resource-id=\"com.tja:id/tvIpacWorker\"]"));
	 PartyMember1.click();
	 Thread.sleep(2000); 
	 getExtentTest().log(LogStatus.PASS,"Successfully Cliked on PartyMember");
	  
	
	  WebElement LeftIcon1 = getmobileDriver() .findElement(By.xpath("//android.widget.ImageView[@resource-id=\"com.tja:id/iv_left_icon\"]"));
	  LeftIcon1.click(); 
	  Thread.sleep(2000); 
	  getExtentTest().log(LogStatus.PASS,"Successfully Cliked on LeftIcon");
	 ...
	 public void BasicDetailsPage() throws Exception {
	  ...
	  WebElement BasicDetails = getmobileDriver() .findElement(By.xpath("//android.widget.TextView[@resource-id=\"com.tja:id/tv_basic_detail\"]"));
	  BasicDetails.click(); 
	  Thread.sleep(2000);
	  getExtentTest().log(LogStatus.PASS,"Successfully Cliked on BasicDetails Page");
	  

	  WebElement EditProfile = getmobileDriver().findElement(By.xpath( "//android.widget.TextView[@resource-id=\"com.tja:id/tv_toolbar_title\"]"));
	  ...
	  WebElement PersonalInformation = getmobileDriver().findElement(By. xpath("//android.widget.TextView[@text=\"Personal Information\"]"));
	  ...
	  WebElement Name = getmobileDriver().findElement(By.xpath( "//android.widget.TextView[@text=\"Name\"]"));
	  ...
	  WebElement userNameElement = getmobileDriver().findElement(By.xpath("//android.widget.EditText[@resource-id=\"com.tja:id/et_user_name\"]")); 
	  ...
	  WebElement userContactNumber = getmobileDriver().findElement(By.xpath("//android.widget.TextView[@text=\"Contact Number\"]"));
	  ...
	  WebElement userMobileNumber = getmobileDriver().findElement(By.xpath(
	 ...
	 "Successfully Verified  UserMobileNumber ");
	  ...
	  WebElement userWhatsAppNumber = getmobileDriver().findElement(By.
	 ...
	 "Successfully Verified  UserWhatsAppNumber ");
	 	...
	 	WebElement WhatsAppNum = getmobileDriver() .findElement(By.xpath(
	 ...
	 "Successfully enterd the WhatsAppNumber"); Thread.sleep(2000);
	  ...
	  WebElement userEmailId = getmobileDriver().findElement(By.
	 ...
	 actualuseruserEmailId + ", Expected: " + expecteduserEmailId); }
	  ...
	  WebElement verifyuserEmailId = getmobileDriver().findElement(By.xpath(
	  ...
	  WebElement RightIocn = getmobileDriver() .findElement(By.xpath("//android.widget.ImageView[@resource-id=\"com.tja:id/iv_right_icon\"]"));
	  RightIocn.click(); 
	  Thread.sleep(2000); 
	...
	*/
	 ...
	 * mobileDriver.manage().window().getSize().getWidth() / 2; int startY = (int)
	 ...
	 * TouchAction((PerformsTouchActions) mobileDriver);
	 ...
	 * TouchAction((PerformsTouchActions) mobileDriver); touchAction
	 ...
	 * 
	 * WebElement userDemographicInfo = getmobileDriver().findElement(By.
	 ...
	 * 
	 * 
	 * WebElement District = getmobileDriver().findElement(By.xpath(
	 ...
	 * 
	 * 
	 * WebElement DIST = getmobileDriver() .findElement(By.xpath(
	 ...
	 * 
	 * 
	 * mobileDriver.findElement(By.xpath("//*[contains(@text,'Views')]");
	 * 
	 * mobileDriver.
	 ...
	 * mobileDriver.manage().window().getSize();
	 * 
	 ...
	 * mobileDriver.findElement(by).isDisplayed(); } catch
	 * (org.openqa.selenium.NoSuchElementException e) { return false; } }
	 * 
	 /* 
	 * WebElement AssemblyConstituency = getmobileDriver().findElement(By.
	 ...
	 * 
	 * WebElement Assembly = getmobileDriver() .findElement(By.xpath(
	 ...
	 * getmobileDriver().findElement(By.
	 ...
	 * 
	 * 
	 * WebElement Education = getmobileDriver().findElement(By.xpath(
	 ...
	 * 
	 * 
	 * WebElement Select = getmobileDriver() .findElement(By.xpath(
	 ...
	 * 
	 * 
	 * WebElement rightIcon = getmobileDriver() .findElement(By.xpath(
	 ...
	 * 
	 * WebElement sectionElement = mobileDriver.findElement(By.xpath(
	 ...
	 * getmobileDriver().findElement(By.xpath(Logo1)).click();
	 * getExtentTest().log(LogStatus.PASS, "Successfully login into the HomePage");
	 * Thread.sleep(20000);
	 * 
	 * 
	 * WebElement Logo = getmobileDriver() .findElement(By.xpath(
	 * "//android.widget.ImageView[@resource-id=\\\"com.tja:id/iv_logo\\\"]"));
	 ...
	 * .moveTo(PointOption.point(startX, endY)) .release() .perform(); }
	 * 
	 * private boolean isElementPresent(By by) { try { mobileDriver.findElement(by);
...
/*
 * 
 * WebElement NAME = getmobileDriver() .findElement(By.xpath(
 ...
 * 
 * WebElement EMAIL = getmobileDriver() .findElement(By.xpath(
 ...
 * 
 * WebElement GENDER = getmobileDriver() .findElement(By.xpath(
 ...
 * Select(mobileDriver.findElement(By.id("android:id/date_picker_header_year")))
 * ; Select dayDropdown = new
 * Select(mobileDriver.findElement(By.id("13 September 1998"))); Select
 * monthDropdown = new Select(mobileDriver.findElement(By.id(
 * "//android.view.View[@resource-id=\"android:id/month_view\"]"))); Select
 * yearDropdown = new Select(mobileDriver.findElement(By.
 ...
 * 
 * 
 * List<WebElement> datePickerBox = mobileDriver.findElements(By.xpath(
 * "//android.widget.TextView[@resource-id=\\\"com.tja:id/ll_dob\\\"]"));
 * 
 ...
 * getExtentTest().log(LogStatus.PASS, "Successfully Entered the Assembly");
 * 
 * WebElement CHEKBOX = getmobileDriver() .findElement(By.xpath(
 ...
 * getmobileDriver().findElement(By.xpath(NEXT11)).click();
 * getExtentTest().log(LogStatus.PASS,
